        ...
        <div class="book">
            <div class="first">
                ...
                <div class="two">
                    ...
                    <div class="int" onclick="location.href='http://jobs.51job.com/all/co563890.html'">
                        <div class="po">职位：Customer Complaint Investigator</div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <div class="de">部门：先进伤口事业部</div>
                    <div class="int" onclick="location.href='http://jobs.51job.com/all/co563890.html'">
                        <div class="po">职位：QA Engineer</div>
                        <div class="di">地点·苏州</div>
                    </div>
                </div>
            </div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <div class="de">部门：先进伤口事业部</div>
                    <div class="int" onclick="location.href='http://jobs.51job.com/all/co563890.html'">
                        <div class="po">职位：Accountant</div>
                        <div class="di">地点·苏州</div>
                    </div>
                </div>
            </div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <div class="de">部门：先进伤口事业部</div>
                    <div class="int" onclick="location.href='http://jobs.51job.com/all/co563890.html'">
                        <div class="po">职位：Project Leader</div>
                        <div class="di">地点·苏州</div>
                    </div>
                </div>
            </div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <div class="de">部门：先进伤口事业部</div>
                    <div class="int" onclick="location.href='http://jobs.51job.com/all/co563890.html'">
                        <div class="po">职位：Packaging Technologistr</div>
                        <div class="di">地点·苏州</div>
                    </div>
                </div>
            </div>
