    ...
    <div class="contents">
        ...
        <div class="book">
            ...
            <div class="first">
                ...
                <div class="two">
                    <p class="de">部门：关节事业部</p>
                    <div class="int" onclick="location.href='https://jobs.51job.com/hebeisheng/118960110.html?s=04'">
                        <div class="po">职位：（高级）销售代表</div>
                        <div class="di">地点·石家庄</div>
                    </div>
                </div>
            </div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <p class="de">部门：关节事业部</p>
                    <div class="int" onclick="location.href='https://jobs.51job.com/shanghai-jaq/118960140.html?s=04'">
                        <div class="po">职位：（高级）销售代表</div>
                        <div class="di">地点·赤峰</div>
                    </div>
                </div>
            </div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <p class="de">部门：关节事业部</p>
                    <div class="int" onclick="location.href='https://jobs.51job.com/shanghai-jaq/118960170.html?s=04'">
                        <div class="po">职位：（高级）销售代表</div>
                        <div class="di">地点·南宁/玉林</div>
                    </div>
                </div>
            </div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <p class="de">部门：关节事业部</p>
                    <div class="int" onclick="location.href='http://jobs.51job.com/all/co563890.html'">
                        <div class="po">职位：Senior Territory Sales Manager</div>
                        <div class="di">地点·广州</div>
                    </div>
                </div>
            </div>
            ...
            <div class="first">
                ...
                <div class="two">
                    <p class="de">部门：先进伤口管理事业部</p>
                    <div class="int" onclick="location.href='https://jobs.51job.com/zhengzhou/119026255.html?s=04'">
                        <div class="po">职位：（高级）销售代表</div>
                        <div class="di">地点·郑州</div>
                    </div>
                </div>
